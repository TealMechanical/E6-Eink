...
try:
    ...
    draw.text((5, 45), u'To Do:', font = font40, fill = epd.GREEN)
    draw.text((5, 85), u'Weather today is:', font = font40, fill = epd.BLUE)
    draw.text((5, 125), u'The Time is:', font = font40, fill = epd.BLACK)
    ...
    Himage = Image.open(os.path.join(picdir, 'Popart.bmp'))
    epd.display(epd.getbuffer(Himage))
    time.sleep(3)
